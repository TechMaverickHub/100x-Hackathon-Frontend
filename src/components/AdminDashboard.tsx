...
interface AnalyticsData {
  user_count: number;
  last_user_registered: string;
  time_till_last_user_registered: string;
...
const AdminDashboard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      try {
        const response = await api.get(API_ENDPOINTS.ANALYTICS_COUNT);
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd className="text-lg font-medium text-gray-900">
                          {loading ? 'Loading...' : analytics?.user_count?.toLocaleString() || '0'}
                        </dd>
                      </dl>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd className="text-lg font-medium text-gray-900">
                          {loading ? 'Loading...' : analytics?.total_sources || '0'}
                        </dd>
                      </dl>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd className="text-lg font-medium text-gray-900">
                          {loading ? 'Loading...' : analytics?.active_sources || '0'}
                        </dd>
                      </dl>
                    </div>
                  </div>
                            ...
                            <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                              <div>
                                <p className="text-sm text-gray-500">
                                  New user registration: {analytics?.last_user_registered || 'No recent registrations'}
                                </p>
                              </div>
                              <div className="text-right text-sm whitespace-nowrap text-gray-500">
                                <time>{analytics?.time_till_last_user_registered || 'N/A'}</time>
                              </div>
                            </div>
                          </div>
                        </div>
